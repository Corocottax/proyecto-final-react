...
const DetalleAnimales = ({ setNavbar }) => {
  ...
  return (
    <div className="detail">
      <Link to="/adopciones" className="volver-detalle">
        <img
          className="imgHeader"
      ...
      <div className="div-compartir-principal">
        <div className="div-compartir">
          <div className="sexonombreyciudad">
            <div className="sexoynombre">
              {animal.sexo === "macho" ? (
                <img
                  className="sexo"
                  src="https://res.cloudinary.com/dhp2zuftj/image/upload/v1644509182/proyecto%20final/male_3x_kcyhge.png"
                  alt="logo macho"
                />
              ) : (
                <img
                  className="sexo"
                  src="https://res.cloudinary.com/dhp2zuftj/image/upload/v1644509182/proyecto%20final/female_3x_x10zv1.png"
                  alt="logo hembra"
                />
              )}
          ...
          <div className="compartir">
            <img
              onClick={agregarFavoritoAUsuario}
              className="img-compartir-corazon"
              src="https://res.cloudinary.com/dhp2zuftj/image/upload/v1644509359/proyecto%20final/favoritos_3x_cfuezi.png"
              alt="logo corazon"
            />
            <img
              className="img-compartir-compartir"
              src="https://res.cloudinary.com/dhp2zuftj/image/upload/v1644507412/proyecto%20final/compartir_3x_ue2hxv.png"
              alt="logo compartir"
            />
          </div>
        </div>
      ...
      <div className="detail-btn-div">
        ...
        <button
          ...
          onClick={() => setShowDetail("adopcion")}
        >
          {" "}
          Adopción
        </button>
      ...
      <div className="detail-info-superior">
        <div className="detail-info">
          {showDetail === "datos" ? (
            <div>
              <DetailData animal={animal} />
            </div>
          ) : showDetail === "salud" ? (
            <DetailHealth animal={animal} />
          ) : (
            <DetailAdoption animal={animal} />
          )}
        </div>
      </div>
          ...
          <div className="popupdetalle">
            ...
            <div className="btn-pop-container">
              <div className="contain1">
                <button className="btn-pop1" onClick={popupCloseHandler}>
                  Cancelar
                </button>
              </div>
              <div className="contain2">
                <Link
                  ...
                  onClick={() => animalLocalStorage(animal)}
                >
                  Continuar
                </Link>
              </div>
